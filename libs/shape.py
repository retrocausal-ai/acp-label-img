...
class Shape(object):
    ...
    scale = 1.0
    label_font_size = 1
    line_width = 2.0  # Configurable bounding box line thickness
    ...
    def paint(self, painter):
        if self.points:
            ...
            pen = QPen(color)
            # Use configurable line width, scaled appropriately
            ...
            if self.paint_label:
                ...
                if min_x != sys.maxsize and min_y != sys.maxsize:
                    ...
                    path = QPainterPath()
                    path.addText(min_x, min_y, font, self.label)
                    outline_pen = QPen(QColor(0, 0, 0), 2, Qt.SolidLine, Qt.RoundCap, Qt.RoundJoin)
