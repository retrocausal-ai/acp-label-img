...
class YoloReader:
    ...
    def __init__(self, file_path, image, class_list_path=None):
        ...
        self.invalid_classes = {}  # Track invalid class indices and their counts
    ...
    def yolo_line_to_shape(self, class_index, x_center, y_center, w, h):
        ...
        # Check if class index is out of bounds
        if class_idx >= len(self.classes) or class_idx < 0:
            # Track invalid class
            if class_idx in self.invalid_classes:
                self.invalid_classes[class_idx] += 1
            else:
                self.invalid_classes[class_idx] = 1
            return None  # Return None to skip this annotation
    ...
    def parse_yolo_format(self):
        ...
        for bndBox in bnd_box_file:
            ...
            # Skip invalid annotations (out of bounds classes)
            if result is None:
                continue
